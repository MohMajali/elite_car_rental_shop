...
if (!$O_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt->bind_param("issss", $office_id, $subscription_type, $start_date, $end_date, $price);
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <?php
$sql1 = mysqli_query($con, "SELECT * from office_subscriptions WHERE office_id = '$O_ID' ORDER BY id DESC");
