...
<html lang="en">
  <head>
    ...
    <title><?php echo $office_name ?> Subscriptions - Elite</title>
  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        <h1><?php echo $office_name ?> Subscriptions</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item"><?php echo $office_name ?> Subscriptions</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <?php
$sql1 = mysqli_query($con, "SELECT * from office_subscriptions WHERE office_id = '$office_id' ORDER BY id DESC");
