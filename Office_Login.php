...
if (isset($_POST['Submit'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM offices WHERE email ='$email' AND password = '$Password'");
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        echo '<script language="JavaScript">
          document.location="Office_Dashboard/";
          </script>';
              ...
              >
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="POST" action="Office_Login.php" id="login-form" >
                      <div class="col-12">
